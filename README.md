...
- Meta-Labeling với mô hình AI kép.
...
| `model_01e.py` | 1e | Meta-Labeling: AI 1 tìm cơ hội, AI 2 kiểm duyệt lệnh. | `chart/TN1e.png` |
...
- Dùng `cross_val_predict` để AI 1 dự đoán trên tập train một cách khách quan hơn.
- Chỉ lấy các dòng mà AI 1 báo MUA để tạo tập train cho AI 2.
- AI 2 học cách phân biệt lệnh MUA nào nên chấp thuận, lệnh nào nên bác bỏ.
- Trên test, AI 1 quét toàn thị trường trước, AI 2 kiểm duyệt từng lệnh MUA.

Kết quả: Win-rate chỉ cải thiện nhẹ lên 37.84%. FP giảm xuống 662 lệnh, nhưng TP cũng giảm xuống 403 lệnh.

Diễn giải: AI 2 có tác dụng cắt bớt lệnh sai, nhưng cũng cắt luôn nhiều lệnh đúng. Hệ thống kép phức tạp hơn nhưng không vượt qua được vùng 40% Win-rate.
...
Hạn chế tồn tại: Recall giảm xuống khoảng 13%. AI trở nên rất khắt khe và từ chối phần lớn cơ hội trên thị trường. Nguyên nhân cốt lõi được xác định là hiện tượng đa cộng tuyến giữa 15 chỉ báo kỹ thuật đầu vào, khiến AI chọn giải pháp an toàn là đứng ngoài thị trường.
