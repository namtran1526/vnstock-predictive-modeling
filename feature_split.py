...
print("HỆ THỐNG XỬ LÝ DỮ LIỆU CHỨNG KHOÁN")
...
print("\nĐang phân tách dòng thời gian (2021-2024 làm Train, 2025-2026 làm Test)")
...
# Lọc tách dữ liệu cho toàn bộ 30 mã cùng lúc
...
print("\nTOP 15 CHỈ BÁO QUYỀN LỰC NHẤT THỊ TRƯỜNG")
...
print(f"Đã tạo file Train:  VN30_Train_Optimized.csv ({train_optimized.shape[0]} dòng, {train_optimized.shape[1]} cột)")
print(f"Đã tạo file Test:   VN30_Test_Optimized.csv ({test_optimized.shape[0]} dòng, {test_optimized.shape[1]} cột)")